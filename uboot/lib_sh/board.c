...
extern int serial_init_pio5 (void);
extern void F450_enable(void);
...
extern int update_process(void);
...
#define CURRENTSVNVERSION "ADAM_VER"
...
/** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** **/
	...
	//ReadSPIFlashDataToBuffer(0x97000, (uchar *)SvnVersionInFlash, 15);
	//SvnVersionInFlash[15]=0;
	//printf("TWPDA UBOOT version: %s\n", SvnVersionInFlash);
	printf("TWPDA UBOOT version: %s\n", CURRENTSVNVERSION);
	...
	if(0 != strncmp(CURRENTSVNVERSION, SvnVersionInFlash, strlen(CURRENTSVNVERSION)))
	{
		...
		SvnVersionInFlash[15]=0;
		printf("writing version %s to flash\n", SvnVersionInFlash);
		WriteSPIFlashDataFromBuffer(0x97000, (uchar *)SvnVersionInFlash, 16);
	}
	*/
    /* iptv project */
//Adam, Disable extern USB detect.
//    update_process();
